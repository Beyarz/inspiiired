...
(function () {
  var Random, SPACEBAR, allowCopy, allowRegeneration, app, appendHistory, assembleHex, currentStyle, displayGuide, generateColumn, hex, hexLength, history, injectColumn, injectNewBackground, int, maxColumnLimit, presentColor, previousStyle;
  Random = class Random {
    constructor(max) {
      this.max = max;
    }
  ...
  injectColumn = function (object) {
    ...
    if (history.childElementCount > maxColumnLimit) {
      return history.childNodes[0].remove();
    }
  };
