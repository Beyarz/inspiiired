...
(function () {
  var Random, SPACEBAR, allowCopy, allowRegeneration, app, appendHistory, assembleHex, currentStyle, displayGuide, firstNode, generateColumn, hex, hexLength, history, injectColumn, injectNewBackground, int, maxColumnLimit, presentColor, previousStyle;
  Random = class Random {
    constructor(max) {
      this.max = max;
    }
